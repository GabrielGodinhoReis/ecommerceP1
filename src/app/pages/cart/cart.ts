    ...
    <div class="max-w-[1200px] mx-auto p-6 text-white space-y-6">
      ...
      <div class="p-4 bg-gray-900 rounded-xl flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <a
            routerLink="/wishlist"
            class="text-purple-400 hover:underline text-sm font-semibold"
          >
            Ver Todos
          </a>
      ...
      @if (store.cartCount() > 0) {
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2 space-y-4">
            ...
            @for (item of store.items(); track item.product.id) {
              ...
              <div
                class="flex items-center justify-between p-4 bg-gray-900 rounded-xl shadow-lg"
              >
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    mat-icon-button
                    (click)="store.updateQuantity(item.product.id, -1)"
                  >
          ...
          <div class="p-6 bg-gray-900 rounded-xl shadow-lg h-fit space-y-4">
            ...
            <div
              class="flex justify-between text-xl font-extrabold border-t border-gray-800 pt-3"
            >
        ...
        <!-- CARRINHO VAZIO -->
        <div
          class="text-center py-16 space-y-4 bg-gray-900 rounded-xl"
        >
...
export default class Cart {
  ...
  addAllFromWishlist() {
    ...
    addedProducts.forEach((product) => {
      this.wishlistStore.removeFromWishlistWithoutMessage(product);
    });
  }
