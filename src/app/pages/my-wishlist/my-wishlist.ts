    ...
    <div class="mx-auto max-w-[1200px] py-6 px-4">
      ...
      @if (store.wishlistCount() > 0) {
        <div class="flex justify-between items-center mb-6">
          ...
          <span class="text-gray-500 text-xl"> {{ store.wishlistCount() }} Jogos </span>
        </div>
        ...
        <div class="mt-8 flex justify-center">
          ...
          >
            <mat-icon class="!m-0 !text-[20px]"> delete_sweep </mat-icon>
            <span> Remover Todos os Jogos da Lista de Desejos </span>
          </button>
        </div>
      } @else {
        <app-empty-wishlist />
